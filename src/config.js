export const config = {
  ...
  pointRadius: 10, // collision radius per point — should be ~half the font size to prevent overlap
  ...
  lineSpacingY: 0.035, // vertical gap between lines as fraction of screen height
  circleX: 0.5, // fraction of screen width
  circleY: 0.45, // fraction of screen height
